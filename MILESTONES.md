# Milestones: Pocket Monsters Let's Go Eevee

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-LetsGoEevee-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters Let's Go Eevee |
...
Coordinate Nintendo Switch findings with Let's Go Pikachu and keep paired-version deltas machine-readable.
