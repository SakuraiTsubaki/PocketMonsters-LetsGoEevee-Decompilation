# Target Profile: Pocket Monsters Let's Go Eevee

## Known repository scope

- Repository: `SakuraiTsubaki/PocketMonsters-LetsGoEevee-Decompilation`
- Working target name: Pocket Monsters Let's Go Eevee
