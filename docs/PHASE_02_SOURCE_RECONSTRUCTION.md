...
Establish the first verified source-reconstruction map for **Pokémon: Let's Go, Eevee!** from a locally extracted Nintendo Switch application tree while keeping cartridge images, encrypted packages, keys, and proprietary executable payloads out of Git.
