...
- Narrow Eevee/Pikachu executable differences without embedding executable bytes in reports.
...
- paired-version modules when performing Eevee ↔ Pikachu comparison
...
5. Compare Eevee ↔ Pikachu only between corresponding verified modules/builds.
